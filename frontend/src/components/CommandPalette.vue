...
import type { Command, CommandInline } from '../types/commands'

// Re-exported so existing imports of these contracts from the SFC keep working.
export type { Command, CommandInline }
